...
const Manager = () => {
    ...
    const savePassword = async () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            toast.error('Error: Password not saved!', { autoClose: 2000 });
        }
    };
        ...
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                ...
                <div className="flex flex-col p-4 text-black gap-8 items-center">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-fuchsia-600 hover:bg-fuchsia-400 rounded-full px-8 py-2 w-fit border border-green-900'>
                        <lord-icon
